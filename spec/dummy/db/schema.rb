...
ActiveRecord::Schema[8.0].define(version: 2025_08_06_064012) do
  create_table "user_passkeys", force: :cascade do |t|
    ...
    t.datetime "last_used_at", default: "1900-01-01 00:00:00", null: false
    t.string "last_used_ip"
    t.string "last_used_user_agent", limit: 1024
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "passkey_user_id", null: false
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["passkey_user_id"], name: "index_users_on_passkey_user_id", unique: true
