webauthn_config = case Rails.env
when "production"
  {
    allowed_origins: ["https://pipeline.socioart.net"],
    rp_id: "pipeline.socioart.net",
  }
else
  {
...
WebAuthn.configure do |config|
  ...
  config.allowed_origins = webauthn_config.fetch(:allowed_origins)

  # Relying Party name for display purposes
  config.rp_name = "Pipeline"
  ...
  #
  config.rp_id = webauthn_config.fetch(:rp_id)
